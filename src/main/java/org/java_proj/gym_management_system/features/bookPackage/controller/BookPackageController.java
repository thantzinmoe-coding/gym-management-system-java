package org.java_proj.gym_management_system.features.bookPackage.controller;
...
import org.java_proj.gym_management_system.features.bookPackage.dto.request.BookPackageRequest;
import org.java_proj.gym_management_system.features.bookPackage.dto.response.BookPackageDetailResponseDto;
import org.java_proj.gym_management_system.features.bookPackage.dto.response.BookedUsersDetailResponse;
...
public class BookPackageController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = org.java_proj.gym_management_system.config.response.dto.ApiResponse.class),
    ...
    @PostMapping
    public ResponseEntity<org.java_proj.gym_management_system.config.response.dto.ApiResponse> bookPackage(
            @Parameter(description = "Booking request details", required = true)
            @Valid @RequestBody BookPackageRequest request) {

        org.java_proj.gym_management_system.config.response.dto.ApiResponse response = bookPackageService.bookPackage(request);
    ...
    public ResponseEntity<org.java_proj.gym_management_system.config.response.dto.ApiResponse> cancelPackage(
        ...
        org.java_proj.gym_management_system.config.response.dto.ApiResponse response = bookPackageService.cancelPackage(id);
    ...
    public ResponseEntity<org.java_proj.gym_management_system.config.response.dto.ApiResponse> getBookingById(@PathVariable("id") Long id, HttpServletRequest request) {
        org.java_proj.gym_management_system.config.response.dto.ApiResponse response = this.bookPackageService.getBookingById(id);
