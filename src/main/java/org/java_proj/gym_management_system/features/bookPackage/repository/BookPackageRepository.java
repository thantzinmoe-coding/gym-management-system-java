package org.java_proj.gym_management_system.features.bookPackage.repository;
...
import org.java_proj.gym_management_system.model.Booking;
...
public interface BookPackageRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("""
    SELECT new org.java_proj.gym_management_system.features.superAdmin.dto.response.BookingDetailResponse(
        b.id,
        m.id,
        m.profile.name,
        m.email,
...
""")
    ...
    @Query("""
        ...
        WHERE agp.trainer.id = :trainerId
          AND b.memberStatus = org.java_proj.gym_management_system.common.constant.MemberStatus.ACTIVE
    """)
